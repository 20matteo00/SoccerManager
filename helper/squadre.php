...
class Squadre {
    ...
    public function __construct($team, $db){
        ...
        $this->coloreBordo  = $params['colore_bordo'] ?? '#000000';
    }

    public function creasquadra(){
        echo "
        <div class='myteam h1 py-2 fw-bold text-uppercase' style='background-color: ".$this->coloreSfondo."; border-color: ".$this->coloreBordo."; color: ".$this->coloreTesto.";'>
            <span>".$this->team."</span>
        </div>
        ";
    }
